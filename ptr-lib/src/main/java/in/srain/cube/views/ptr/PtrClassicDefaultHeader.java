...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private static SimpleDateFormat sHourFormat = new SimpleDateFormat("HH:mm:ss");
    ...
    protected void initViews(Context context,AttributeSet attrs) {
        ...
        if (android.os.Build.VERSION.SDK_INT > 22) {//android 6.0替换clip的加载动画
            final Drawable drawable =  context.getApplicationContext().getResources().getDrawable(R.drawable.progress_loading_v23);
    ...
    private String getLastUpdateTime() {
        ...
        if(hours > 24){
            ...
            sb.append(sHourFormat.format(date));
        }
