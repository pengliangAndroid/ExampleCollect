...
public class TranslucentScrollView extends ScrollView {
    ...
    public void setTransView(View transView) {
        setTransView(transView, getResources().getColor(R.color.colorPrimary), DeviceUtils.dp2px(getContext(), DFT_TRANSSTARTY), DeviceUtils.dp2px(getContext(), DFT_TRANSENDY));
    }
        ...
        if (zoomView != null) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    int distance = (int) ((event.getY() - mFirstPosition) * 0.2);
                    if (distance < 0) {
                        break;
                    }
                    mScaling = true;
