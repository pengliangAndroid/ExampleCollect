...
public class PercentageRing extends View{
    ...
    private float mTargetPercent = 75;
    private float mCurrentPercent = 75;

    private int mCurrentAngle = 75;
    private int mRadius;
    ...
    public PercentageRing(Context context, AttributeSet attrs) {
        ...
        //外圆环的颜色  默认为深紫色
        mRingColor = Color.parseColor("#");
                //typedArray.getColor(R.styleable.PercentageRing_ringColor, 0xff6950a1);
        //中间圆的半径 默认为60
    ...
    private void init(Context context){
      ...
      /*  mCirclePaint = new Paint();
        ...
        mArcPaint.setStrokeWidth((float) (0.1*mRadius));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //画中心园的外接矩形，用来画圆环用
        //mArcRectF = new RectF(0,0, width*2, height*2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(rectf_head, 0 ,270, false, mArcPaint);
        //画文字
